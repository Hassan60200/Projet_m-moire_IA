...
def load_data():
    ...
    df_chomage = df_chomage[df_chomage['code_departement'] == '60']
    df_logement = df_logement[df_logement['Départements'] == 'Oise']
    df_logement = df_logement[df_logement['Code'] == '60']
    ...
    return dvf, df_chomage, df_logement
